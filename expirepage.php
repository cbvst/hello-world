        ...
        <nav class="navbar navbar-expand dashboard-top-header bg-white">
            <div class="container-fluid">
                ...
                <div class="dashboard-nav-brand">
                    <a class="dashboard-logo" href="../index.html">Error</a>
                </div>
                <!-- ============================================================== -->
                <!-- end brand logo -->
                <!-- ============================================================== -->
                    ...
                    <div class="offset-xl-2 col-xl-8 offset-lg-2 col-lg-8 col-md-12 col-sm-12 col-12">
                        <div class="error-section">
                            ...
                            <div class="error-section-content">
                                <h1 class="display-3">Link Expire</h1>
                                <p> You have already changed your password using this link.</p>
                                <p> this link is expire.</p>
                                <a href="login.php" class="btn btn-success btn-lg">Go to Login Page</a>
                                <a href="forgot-password.php" class="btn btn-warning btn-lg">Go to Forgot Password Page</a>
                            </div>
                        </div>
                    </div>
                </div>
