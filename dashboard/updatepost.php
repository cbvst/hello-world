...
<?php
    ...
    $query="select * from task1_posttbl where post_id='$postid'";
...
<body>
    ...
    <div class="dashboard-main-wrapper">
        <input type="hidden" name="hideid" value="<?= $_REQUEST['postid']; ?>" />
        <!-- ============================================================== -->
        <!-- navbar -->
        <!-- ============================================================== -->
                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="ecommerce-widget">
                        ...
                        <div class="row">
                            ...
                            <form action="updatepostcode.php?upid=<?php echo $row['post_id']; ?>" method="post">
                                
                                <div class="form-group">
                                    <label for="exampleFormControlTextarea1">Write your post</label>
                                    <textarea class="form-control" name="postedititem" rows="3"><?= $row['post_item']; ?></textarea>
                                </div>
                                <div class="form-group">
                                    
                                    <input type="submit" class="btn btn-success" style="float:right;" value="Update Post" name="btnsubmitpost">
                                </div>                                     
