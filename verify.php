                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="registrationcode.php" enctype="multipart/form-data">
                         ...
                         <div class="row row-space">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    <input class="input--style-1" type="text" placeholder="LAST NAME" name="lname" required>
                                </div>
                            </div>
                        </div>
                        <div class="input-group">
                            <input class="input--style-1" type="number" placeholder="Contact Number" name="mobile" required>
                        </div>                           
                
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    <input class="input--style-1" type="date" placeholder="DATE OF BIRTH" name="birthdate" required>
                        ...
                        <div class="input-group">
                            <input class="input--style-1" type="file" placeholder="Select Photo" name="userpic" required>
                        </div>        
                        <div class="p-t-20">
